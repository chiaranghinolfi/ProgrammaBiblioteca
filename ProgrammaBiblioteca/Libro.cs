       ...
       // private string _titolo;
        ...
        public bool presta(Utente utente)
        {
            if (utente.libriPresi.Count < 6 && prestato == false) {
                ...
                prestato = true;
                MessageBox.Show("Libro prestato!", "Prestito", MessageBoxButtons.OK ); 
                return true;
            }
            else {
                MessageBox.Show("Non è possibile concludere il prestito", "Prestito", MessageBoxButtons.OK, MessageBoxIcon.Hand);
                return false;
            }
        }
    }
